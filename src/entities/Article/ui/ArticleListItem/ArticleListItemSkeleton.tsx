  ...
  return (
    <div className={classNames(cls.articleListItem, {}, [className, cls[view]])}>
      <div className={classNames(cls.articleListItemPoster, {}, [cls[view]])}>
        <Skeleton height={170} width={view === ArticleView.GRID ? '100%' : 300} />
      </div>
      <div className={classNames(cls.articleListItemContent, {}, [cls[view]])}>
        <div style={{ marginTop: 10 }} className={classNames(cls.tags, {}, [cls[view]])}>
          <Skeleton width={70} height={20} />
          <Skeleton width={70} height={20} />
          <Skeleton width={70} height={20} />
        </div>
        <Skeleton style={{ marginBottom: 10 }} width={200} height={30} />
