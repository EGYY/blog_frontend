...
export const ProfileArticleItemWithActions = ({ article, onDeleteArticle }: ProfileArticleItemWithActionsProps) => {
    ...
    <div className={cls.lastArticleItem}>
      ...
      <div className={cls.lastArticleActions}>
        <Tooltip content={t('edit')}>
          <Button to={getRouteArticleUpdate(article.id)} theme="ghostIcon"><EditIcon width={20} /></Button>
        </Tooltip>
        <Tooltip content={t('delete')}>
          <Button onClick={() => setShowConfirm(true)} theme="ghostIcon"><DeleteIcon width={20} /></Button>
        </Tooltip>
        <Confirm
          open={showConfirm}
