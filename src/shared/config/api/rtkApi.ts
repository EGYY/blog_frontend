...
const axiosBaseQuery = (axiosInstance: typeof axiosWithAuth): BaseQueryFn<
AxiosBaseQueryArgs,
unknown,
unknown
> => async ({
...
const baseQuery: BaseQueryFn<AxiosBaseQueryArgs, unknown, unknown> = async (args, api, extraOptions) => {
  const isPublic = typeof args === 'object' && 'headers' in args && args.headers?.['x-public'];
