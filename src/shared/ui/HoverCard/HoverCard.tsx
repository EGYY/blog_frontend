...
export const HoverCard: React.FC<HoverCardProps> = memo(
    ({ trigger, content, side = 'top', offset = 8 }) => {
        ...
        const calculatePosition = useCallback(() => {
            ...
            const tryPosition = (preferred: typeof side): boolean => {
                ...
                const fitsVertically =
                    top >= scrollY &&
                    top + contentRect.height <= window.innerHeight + scrollY;
                const fitsHorizontally =
                    left >= scrollX &&
                    left + contentRect.width <= window.innerWidth + scrollX;

                return fitsVertically && fitsHorizontally;
            };

            const sides: HoverCardProps['side'][] = [
                side,
                'bottom',
                'top',
                'right',
