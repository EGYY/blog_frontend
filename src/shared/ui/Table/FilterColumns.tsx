...
function FilterColumnsComponent<T extends Record<string, any>>(
    props: FilterColumnsProps<T>,
) {
    const { setColumns, columns, className } = props;
...
export const FilterColumns = memo(
    FilterColumnsComponent,
) as typeof FilterColumnsComponent;
